...
Можно создать разрешающий модуль, как предагает вывод команды sealert:
...
- Создадим небазовый модуль политики с включённой системой безопасности MLS/MCS "syslog_audit.mod" на основе  
